...
@NamedQueries({
        ...
        @NamedQuery(name = "employeeDeptAlias", query = "SELECT e, e.officeCode, e.name, " + "CASE " +
...
public class Employee {
    ...
    public String toString() {
        return "Employee [id=" + id + ", name=" + name + ", salary=" + salary + ", job=" + job + ", addressLine=" + addressLine + ", zipcode=" + zipcode + ", city=" + city + ", startDate=" + startDate + "]";
    }
